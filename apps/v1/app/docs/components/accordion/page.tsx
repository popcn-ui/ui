      ...
      Yes. Update theme tokens to match your brand.
        ...
        >
          <Accordion type="single" collapsible className="w-full max-w-lg">
            <AccordionItem value="item-1">
              <AccordionTrigger>What is AuroraPop?</AccordionTrigger>
              <AccordionContent>A gradient-driven, motion-rich design system.</AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>Is it customizable?</AccordionTrigger>
              <AccordionContent>Yes. Update theme tokens to match your brand.</AccordionContent>
            </AccordionItem>
          </Accordion>
        </ComponentPreview>
      </section>
